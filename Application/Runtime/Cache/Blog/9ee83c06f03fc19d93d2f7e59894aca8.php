    ...
    <div class="box_index timeline clearfix">
        ...
        <div class="timeline_text">
            <div class="timeline_desc">
                ...
                <div class="line"></div>
                <div class="timeline_tips"><span class="timeline_time"><?php echo date('Y年m月d日',$v['addtime']);?> 来自轻博客(SoftBlog)</span><span class="timeline_comment"><a href=""><i class="icon_timeline" title="评论"></i>评论</a></span><span class="timeline_ready"><a href=""><i class="icon_timeline" title="查看"></i>查看</a></span></div>
            </div>
        </div>
