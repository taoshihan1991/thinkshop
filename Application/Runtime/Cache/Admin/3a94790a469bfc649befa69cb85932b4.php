...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="" class="action">修改品牌</a></li>
        </ul>
    </div>
    <div class="title-header">修改品牌</div>
    <form method="post" class="hd-form" action="<?php echo U('Brand/update');?>" enctype="multipart/form-data">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="<?php echo ($info["logo"]); ?>" class="thumbShow" />
                </td>
            </tr>
            <tr>
                <th class="w100">排序</th>
