...
<form action="<?php echo U('Goods/update');?>" method="post" class="hd-form" >
    <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>"/>
    <div class="wrap">
        <div class="menu_list">
            <ul>
               <li><a href="<?php echo U('Goods/index');?>">商品列表</a></li>
                <li><a href="" class="action">修改商品</a></li>
            </ul>
        </div>
            ...
            <div class="tab_content">
                <div id="web">
                    <table class="table1">
                                ...
                                <tr>
                                    ...
                                    <td class="w250">
                                        <input type="text" name="name" value="<?php echo ($info["name"]); ?>" class="w400"/>
                                    </td>
                                </tr>                        
                                <tr>
                                    <th class="w100">商品广告语</th>
                                    <td class="w250">
                                        <input type="text" name="goods_ad" value="<?php echo ($info["goods_ad"]); ?>" class="w400"/>
                                    </td>
                                </tr>                         
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <select name="brand_id" class="w200">
                                                    <option value="0">请选择</option>
                                                        <?php if(is_array($brand)): foreach($brand as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($info['brand_id']==$v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td class="w250">
                                        <input type="text" name="pro_no" value="<?php echo ($info["pro_no"]); ?>" class="w400"/>
                                    </td>
                                </tr>  
                                <tr>
                                    <th class="w100">重量</th>
                                    <td class="w250">
                                        <input type="text" name="weight" value="<?php echo ($info["weight"]); ?>" class="w400"/>
                                    </td>
                                </tr>    
                                <tr>
                                    <th class="w100">商城价</th>
                                    <td class="w250">
                                        <input type="text" name="sell_price" value="<?php echo ($info["sell_price"]); ?>" class="w400"/>
                                    </td>
                                </tr>  
                                <tr>
                                    <th class="w100">市场价</th>
                                    <td class="w250">
                                        <input type="text" name="market_price" value="<?php echo ($info["market_price"]); ?>" class="w400"/>
                                    </td>
                                </tr> 
                                <tr>
                                    <th class="w100">仓库量</th>
                                    <td class="w250">
                                        <input type="text" name="store_nums" value="<?php echo ($info["store_nums"]); ?>" class="w400"/>
                                    </td>
                                </tr>                  
                        </table>
                </div>
                <div id="rewrite">
                    ...
                    <tr>
                                    ...
                                    <td>
                        <textarea name='content' id="content" class='w650 h400'><?php echo ($info["content"]); ?></textarea>
                        </td>
                    </tr>
                    </table>
                </div>
                <div id="upload">
                    <table class="table1">
                        <tr>
                                    ...
                                    <td class="w250">
                                        <input type="text" name="seo_title" value="<?php echo ($info["seo_title"]); ?>" class="w400"/>
                                    </td>
                        </tr> 
                        <tr>
                                    <th class="w100">seo关键字</th>
                                    <td class="w250">
                                        <input type="text" name="seo_keywords" value="<?php echo ($info["seo_keywords"]); ?>" class="w400"/>
                                    </td>
                        </tr>  
                        <tr>
                                    <th class="w100">seo描述</th>
                                    <td>
                        <textarea name='seo_description' class='w400 h100'><?php echo ($info["seo_description"]); ?></textarea>
                        </td>
                    </tr>   
                    </table>
                </div>
                <div id="member">
                    <table class="table1">
                                <tr>
                                    ...
                                    <td>
                                        <select name="type_id" class="w200 goodsType" data-typeid="<?php echo ($info["type_id"]); ?>" data-goodsid="<?php echo ($info["id"]); ?>">
                                                    <option value="0">请选择</option>
                                                        <?php if(is_array($types)): foreach($types as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"
                                                        <?php if($info['type_id']==$v['id']): ?>selected="selected"<?php endif; ?>
...
$(function(){
    ...
    var type_id=$('.goodsType').attr('data-typeid'); 
    var goods_id=$('.goodsType').attr('data-goodsid'); 
    if(type_id){
        var url="<?php echo U('Attribute/ajaxType');?>";
        $.ajax({
            type:'GET',
