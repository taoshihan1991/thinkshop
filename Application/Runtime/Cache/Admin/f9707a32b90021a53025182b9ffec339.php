...
<div class="wrap">
    <div class="menu_list">
        <ul>
            <li><a href="javascript:;" class="action">分类列表</a></li>
            <li><a href="<?php echo U('Articleclass/add');?>">添加栏目</a></li>
        </ul>
    </div>
    <table class="table2 hd-form">
        ...
        <tr>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                <td><?php echo ($v["id"]); ?></td>
                <td><?php echo str_repeat("&nbsp;&nbsp;",$v['level']); if($v['level']): ?>└─<?php endif; echo ($v["name"]); ?></td>
                <td>
                    <a href="<?php echo U('Articleclass/update',array('id'=>$v['id']));?>">修改</a> 
                    <span class="line">|</span> 
                    <a href="<?php echo U('Articleclass/delete',array('id'=>$v['id']));?>">删除</a>
                </td>
